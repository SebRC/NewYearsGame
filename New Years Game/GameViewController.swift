...
class GameViewController: UIViewController{
    ...
    var questions = [
        Question(description: "Hvad går den tredje leg i Squid Game ud på?", points: 2,  answer: "Tug of war/Tovtrækning", id: 0),
        Question(description: "Hvem er ældst?", points: 5,  answer: "Henrik", id: 1),
        Question(description: "Hvad er en Amager plade?", points: 2,  answer: "En tatovering lige over røven 🍑", id: 2),
        Question(description: "Hvad siger folk fra Amager når de sværger?", points: 2,  answer: "Amager halshug", id: 3),
        Question(description: "Hvad er det mærkeligste du nogensinde har drømt?", points: 2,  answer: "❓", id: 4),
        //Question(description: "Hvem er sejest?", points: 2,  answer: "Amalie 😊", id: 5),
        Question(description: "Fortæl to løgne og en sandhed.\nDe andre skal gætte som en gruppe. Du får point hvis de gætter forkert.", points: 3,  answer: "❓", id: 6),
        Question(description: "Fortæl to løgne og en sandhed.\nDe andre skal gætte som en gruppe. Du får point hvis de gætter forkert.", points: 3,  answer: "❓", id: 7),
        Question(description: "Hvor langt nåede det danske fodboldslandshold til EM 2020 og hvem slog dem ud?", points: 2,  answer: "Semifinalerne. De blev slået ud af England.", id: 8),
        Question(description: "Hvem blev den første private borger til at rejse ud i rummet i deres eget rumskib?", points: 3,  answer: "Richard Branson. Han gjorde det 9 dage før Jeff Bezos.", id: 9),
        Question(description: "Hvad er det vildste du har gjort i dit liv?", points: 2,  answer: "❓", id: 10),
        Question(description: "Hvilket job forestillede du dig du skulle have da du var barn?", points: 1,  answer: "❓", id: 11),
        Question(description: "Hvis du kunne vælge en superkræft, hvad skulle det så være og hvorfor?", points: 2,  answer: "❓", id: 12),
        Question(description: "Hvor mange mål lukkede det danske fodboldslandshold ind i VM kvalifikationen til Qatar 2022?", points: 2,  answer: "3", id: 13),
        //Question(description: "Hvad bliver det legendariske Arsenal hold fra 2003-2004 sæsonen kaldt?", points: 2,  answer: "The Invincibles 🏆", id: 14),
        Question(description: "Hvad er det dummeste du har gjort mens du var fuld?", points: 2,  answer: "🍻❓", id: 15),
        Question(description: "Hvad er den mest irriterende vane du har?", points: 2,  answer: "🤬❓", id: 16),
        Question(description: "Hvad er det dummeste du har gjort som barn?", points: 3,  answer: "👶🏼❓", id: 17),
        Question(description: "Hvad er det pinligste du har grædt over?", points: 1,  answer: "❓", id: 18),
        Question(description: "Hvilket dyr minder mest om din højre sidemand og hvorfor?", points: 2,  answer: "❓", id: 19),
        Question(description: "Hvad kommer efter 20?", points: 2,  answer: "Politi 🚓", id: 20),
        Question(description: "Hvad kommer efter 20?", points: 2,  answer: "21", id: 21),
        Question(description: "Hvor gammel er Beyonce?", points: 2,  answer: "40", id: 22),
        //Question(description: "Bum leg", points: 2,  answer: "Bum", id: 23),
        Question(description: "Finish the lyrics\nOtto Brandenburg: Jeg ved en ... jeg siger ikke mer", points: 2,  answer: "lærkerede 🕊", id: 24),
        Question(description: "Finish the lyrics\nEd Sheeran: My bad habits lead to ...", points: 2,  answer: "late nights ending alone", id: 25),
        Question(description: "Finish the lyrics\nPSY: Oppan Ganganm Style ...", points: 2,  answer: "Ehhh sexy lady", id: 26),
        Question(description: "Finish the lyrics In the jungle, the mighty jungle ...", points: 2,  answer: "the lion sleeps tonight 🦁", id: 27),
        Question(description: "Hvem blev kåret til den bedste kvindelige fodboldspiller i 2021?", points: 2,  answer: "Alexia Putellas ⚽️", id: 27),
        Question(description: "Hvilken placering fik det danske kvindehåndboldshold til VM i 2021?", points: 2,  answer: "Bronze 🥉", id: 28),
        Question(description: "Hvad er Bilkas slogan?", points: 2,  answer: "Hvem ka' Bilka", id: 29),
        Question(description: "Hvad er Burger Kings slogan?", points: 2,  answer: "Have It Your Way", id: 30),
        Question(description: "Hvad er L'Oreals slogan?", points: 2,  answer: "Because you're worth it", id: 31),
        Question(description: "Hvad hedder tigeren i Peter Plys?", points: 3,  answer: "Tigerdyr", id: 32),
        Question(description: "Tegn et dyr. Hvis dyret bliver gættet får tegneren point. Du kan se hvad du skal tegne i svar feltet.", points: 3,  answer: "Tegn en Kameleon", id: 33),
        Question(description: "Tegn et dyr. Hvis dyret bliver gættet får tegneren point. Du kan se hvad du skal tegne i svar feltet.", points: 3,  answer: "Tegn en Klovnefisk", id: 34),
        Question(description: "Nyn din yndlingssang", points: 1,  answer: "🎶", id: 35),
        Question(description: "Mim en berømt. Du kan se hvem du skal mime i svarfeltet.", points: 2,  answer: "Mette Frederiksen", id: 36),
        Question(description: "Lærke er ...", points: 3,  answer: "💆🏼‍♀️", id: 37),
        Question(description: "Sten, Saks, Papir", points: 2,  answer: "🗿✂️📄", id: 38),
        Question(description: "Kategori", points: 3, answer: "Ting", id: 39),
        Question(description: "Kategori", points: 3, answer: "Ting", id: 40),
        Question(description: "Hvilket fodboldhold er Lærke fan af?", points: 3,  answer: "Manchester City 🔵", id: 41),
        Question(description: "Hvem er Lærkes yndlings fodboldspiller?", points: 3,  answer: "Spørg Lærke", id: 42),
        Question(description: "Hvad er Arsenals motto?", points: 10,  answer: "Victoria Concordia Crescit(Victory Through Harmony)", id: 43),
        Question(description: "Hvor gammel bliver Lærke?", points: 1,  answer: "50, men hun ser ikke ud som en dag over 25 😯", id: 44),
        Question(description: "Hvem er Lærkes yndlings svigersøn?", points: 3,  answer: "Det er selvfølgelig både Niklas og Seb 🤝", id: 45),
        Question(description: "Hvor mange Spider-Man film er der lavet med de tre nyeste skuspillere i rollen(Toby Maguire, Andrew Garfield, Tom Holland)?", points: 3,  answer: "8 🕷", id: 46),
        Question(description: "Hvad hedder den andelsforening Lærke bor i?", points: 5,  answer: "A/B Sandkagen 🍰", id: 46),
        Question(description: "Hvor gammel er Mini?", points: 3,  answer: "Spørg Lærke 🐩", id: 47),
        Question(description: "Hvad hedder Laura og Niklas hund?", points: 3,  answer: "Sofus 🐶", id: 48),
        Question(description: "Hvad hedder ham den lækre sundhedsminister?", points: 3,  answer: "Magnus Heunicke 😍", id: 49),
        Question(description: "I maj 2021 tog Lærke en tur med nogle veninder. Hvor tog hun hen?", points: 3,  answer: "Buddhi Camp 😋", id: 50),
        Question(description: "Hvilke karakterer fik Amalie og Laura i deres bachelor eksamener?", points: 3,  answer: "12 og 12 👩🏼‍🎓👩🏼‍🎓", id: 51),
        Question(description: "Hvad er Mette Frederiksens mellemnavn?", points: 3,  answer: "Hun har ikke et mellemnavn", id: 52),
        //Question(description: "Hvem vandt 3F Superligaen i 20/21?", points: 2,  answer: "Brøndby IF", id: 53),
        Question(description: "Hvilken dansk film vandt Oscaren for Bedste internationale film i 2021?", points: 3,  answer: "Druk(Another Round)", id: 54),
    ]
