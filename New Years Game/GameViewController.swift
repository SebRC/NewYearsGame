...
class GameViewController: UIViewController{
    ...
    var questions = [
        ...
        Question(description: "Hvad hedder den andelsforening Lærke bor i?", points: 1,  answer: "A/B Sandkagen 🍰", id: 46),
        Question(description: "Hvor gammel er Mini?", points: 1,  answer: "Spørg Lærke 🐩", id: 47),
        Question(description: "Hvad hedder Laura og Niklas hund?", points: 1,  answer: "Sofus 🐶", id: 48),
        Question(description: "Hvad hedder ham den lækre sundhedsminister?", points: 1,  answer: "Magnus Heunicke 😍", id: 49),
        Question(description: "I maj 2021 tog Lærke en tur med nogle veninder. Hvor tog hun hen?", points: 1,  answer: "Buddhi Camp 😋", id: 50),
        Question(description: "Hvilke karakterer fik Amalie og Laura i deres bachelor eksamener?", points: 1,  answer: "12 og 12 👩🏼‍🎓👩🏼‍🎓", id: 51),
        Question(description: "Hvad er Mette Frederiksens mellemnavn?", points: 1,  answer: "Hun har ikke et mellemnavn", id: 52),
        ...
        Question(description: "Hvad er Lærkes yndlingsfarve?", points: 1, answer: "Grøn💚", id: 67)
